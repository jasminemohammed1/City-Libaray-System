...
namespace CityLibaraySystem.Helpers
{
    public static class DataSeader
    {
        public static LibraryBranch DataSead()
        {
            // ── Librarian ────────────────────────────────────────────
            Librarian manager = new("LIB-01", "Sara Ahmed", 8500m, new DateOnly(2019, 3, 15), "01012345678");
            // ── Branch ───────────────────────────────────────────────
